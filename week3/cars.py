...
def process_data(data):
	"""Analyze the data, looking for maximums.
	...
	for item in data:
		#Caculate the revenue generated by this model (price * total_sales)
...
def main(argv):
	...
	# TODO: turn this into a PDF reports
	report("/tmp/cars.pdf", "Cars report", new_summary, cars_dict_to_table(data))
	
	# TODO: Send the PDF report as an email attachment
	msg = email_generate("automation@example.com", "{}@example.com".format(os.environ.get('USER')), "Sales summary for last month", new_summary, '/tmp/cars.pdf')
	email_send(msg)
